<%@ Page Title="" Language="C#" MasterPageFile="~/master_page.Master" AutoEventWireup="true" CodeBehind="AnasayfaKategoriDetay.aspx.cs" Inherits="YemekSite.AnasayfaPages.KategoriDetay" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>

<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        <asp:DataList ID="dtlist_KategoriDetay" runat="server" CellPadding="4" ForeColor="Black" AlternatingItemStyle-BorderColor="Black" AlternatingItemStyle-BorderStyle="Solid" AlternatingItemStyle-BorderWidth="1px">
            <ItemTemplate>
                <a style="text-decoration: none; color: inherit;" href='<%# "YemekDetay.aspx?yemek_id=" + Eval("yemek_id") %>'>
                    <asp:Label CssClass="baslik" ID="LabelYemekAdi" runat="server" Text='<%# Eval("yemek_ad") %>' BackColor="#FFFF66" Font-Size="30px" ForeColor="#FF6666"></asp:Label>
                </a>
                <br />
